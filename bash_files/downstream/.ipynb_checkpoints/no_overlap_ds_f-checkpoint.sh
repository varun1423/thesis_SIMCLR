...
#SBATCH --output=out_no_o.%j
#SBATCH --error=err_no_o.%j
...
python /p/project/hai_ssl4sc/hai_thesis_simcLR/orig_wo_normalize_intransform/down_stream_simCLR.py \
    ...
    --batch_size 30\
    --encoder_fine_tune \
    --ckpt /p/project/hai_ssl4sc/hai_thesis_simcLR/orig_wo_normalize_intransform/bash_files/ckpt_all/baseline_wo_norm_ckpt/ckpt_10000__final_no_overlap.pt