...
#SBATCH --output=out_b.%j
#SBATCH --error=err_b.%j
...
python /p/project/hai_ssl4sc/hai_thesis_simcLR/orig_wo_normalize_intransform/down_stream_simCLR.py \
    ...
    --batch_size 30\
    --encoder_fine_tune \
    --ckpt /p/project/hai_ssl4sc/hai_thesis_simcLR/orig_wo_normalize_intransform/bash_files/ckpt_all/ckpt__2biuc17d/ckpt_350__final_.pt