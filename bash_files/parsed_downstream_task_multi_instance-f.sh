...
#SBATCH --job-name=f_multi_instance
...
python /p/project/hai_consultantfzj/set_up/simclr_with_down_stream/thesis_SIMCLR/down_stream_simCLR.py \
    ...
    --epochs 50 \
    --batch_size 320\
    --ckpt /p/project/hai_consultantfzj/set_up/simclr_with_down_stream/thesis_SIMCLR/final_split_ckpt/first_run_on_final_data/ckpt_10000__multi_instance.pt
