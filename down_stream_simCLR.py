...
parser.add_argument('--train_dir', type=str, required=False, default="/p/project/hai_consultantfzj/set_up/solo-learn_SSL/dataset_crop_imgs/",
                    help="train dir points to csv dir ")
parser.add_argument('--data_dir', type=str, required=False, default="tbc_with_lifetime/data_with_Lifetime",
                    help="train dir/data_dir")
...
functions_file.get_metrics(downstream_model,
                           validation_set,
                           device,
                           config.num_classes)
